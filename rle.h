// Run Length Encoding -- [un]compressbitmap()
// need bitmap drawing routines because no GL buffer
// windows buffer isn't really readable either ...
// duplicate ! shadow realm bitmaps
